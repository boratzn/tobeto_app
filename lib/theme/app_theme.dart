...
ThemeData lightMode = ThemeData(
    ...
    textTheme: const TextTheme(
      ...
      titleMedium: TextStyle(
          color: Color(0xFF1D1B1E), fontFamily: 'Tinos', fontSize: 16),
      labelSmall: TextStyle(
          color: Color(0xFF7B757F), fontFamily: 'Tinos', fontSize: 16),
      labelMedium: TextStyle(
          color: Color(0xFF850BEC), fontFamily: 'Tinos', fontSize: 17),
    ),
...
ThemeData darkMode = ThemeData(
    ...
    textTheme: const TextTheme(
      titleLarge:
          TextStyle(color: Colors.white, fontFamily: 'Tinos', fontSize: 18),
      titleMedium: TextStyle(
          color: Color(0xFFE7E1E5), fontFamily: 'Tinos', fontSize: 16),
      labelSmall: TextStyle(
          color: Color(0xFF958E98), fontFamily: 'Tinos', fontSize: 16),
      labelMedium: TextStyle(
          color: Color(0xFFDAB9FF), fontFamily: 'Tinos', fontSize: 17),
    ),
    cardTheme: CardTheme(
      color: const Color(0xFF470084),
